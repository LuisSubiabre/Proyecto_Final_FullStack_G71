  ...
  return (
    <div className='bg-[url("https://res.cloudinary.com/dxxrdckad/image/upload/v1730842164/Green_and_Blue_Illustrative_World_Friendship_Day_Banner_Landscape_izseal.png")] bg-cover bg-center flex flex-col items-center justify-center min-h-screen font-osvald'>
      <div className="absolute top-4 left-4 flex items-center">
        ...
        />
        <a href="/" className="ml-2 text-[20px] font-bold text-[var(--color-primary-light)] hover:text-[var(--color-primary-dark)] hover:underline">Regresar a inicio</a>
      </div>
      <div className="flex flex-col lg:flex-row items-center justify-center w-full max-w-4xl px-4">
        ...
        <Card className="bg-[var(--color-primary-light)] p-8 rounded-lg shadow-lg w-full max-w-md">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            />
            <Button fullWidth color="primary" type="submit" className="py-2 rounded-lg font-bold text-lg hover:bg-[var(--color-primary-dark)] hover:text-white transition">
              Ingresar
            </Button>
            <Button 
              fullWidth 
              ...
              onClick={() => navigate("/recover-password")} // Redirecciona al componente de recuperación de contraseña
            >
              Recuperar cuenta
            </Button>
          </form>
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        <ModalContent>
          <ModalHeader>{successMessage ? "¡Bienvenido!" : "Error en el formulario"}</ModalHeader>
          <ModalBody>

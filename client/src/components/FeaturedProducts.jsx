...
const FeaturedProducts = () => {
  return (
    <div className="relative w-full py-4 bg-[url('https://res.cloudinary.com/libreriaalondra/image/upload/v1729796934/fondo_producto_destacado_cbu2jz.jpg')] bg-cover">

...
export default function Footer() {
  return (
    <footer className="w-full bg-[--color-primary-dark] text-white">
      <div className='bg-[url("https://res.cloudinary.com/libreriaalondra/image/upload/v1729796934/fondo_producto_destacado_cbu2jz.jpg")] h-2 sm:h-4 md:h-5 lg:h-6'></div>
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 p-4">
        {dataFooter.footerData.columns.map((column) => (
          ...
          >
            <h3 className="font-bold !tex-oswald text-lg mb-2">
              {column.title}
            </h3>

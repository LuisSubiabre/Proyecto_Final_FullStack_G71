      ...
      <div className="overflow-hidden w-full h-full" ref={emblaRef}>
        <div className="flex">
          ...
          <div className="flex-[0_0_100%] h-[150px] md:h-[250px] lg:h-[350px] xl:h-[400px]">
            <img
              src="https://res.cloudinary.com/libreriaalondra/image/upload/v1736905877/gif_alas_alondra_rwaqe5.gif"
          ...
          <div className="flex-[0_0_100%] h-[150px] md:h-[250px] lg:h-[350px] xl:h-[400px]">
            <img
              src="https://res.cloudinary.com/libreriaalondra/image/upload/v1729711111/banner_artel_ma4ndx.webp"
              alt="Productos artel"
              className="w-full h-full object-cover"
            />
          </div>
          ...
          <div className="flex-[0_0_100%] h-[150px] md:h-[250px] lg:h-[350px] xl:h-[400px]">
            <img
              src="https://res.cloudinary.com/libreriaalondra/image/upload/v1729714379/Slider_STABILO_BOSS_23er_deskset_1860x750_ahm7t6.jpg"
              alt="destacadores"
              className="w-full h-full object-cover"
            />
          </div>
